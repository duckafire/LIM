#ifndef INTERFACE_ARGS_FLAGS
#define INTERFACE_ARGS_FLAGS
...
#define HELP_ARG_RULES         "r", "rules"
#define HELP_ARG_HEADER        "h", "header"
#define HELP_ARG_SYNOPSIS      "s", "synopsis"
#define HELP_ARG_LIST_SYNOPSIS "ls", "list-syn"
